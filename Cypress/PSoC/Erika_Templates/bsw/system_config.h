...
//-------------------------------------------------------------------- [System String]
#define CFG_SYS_STR                 "Boardtest v1.0 (c) H-DA, P. Fromm"    
...
/** \brief Buffer size for CANopen RX ringbuffer */
#define CANOPEN_CFG_RB_L            30
    
/** \brief NodeID of this CANopen Node */
#define CANOPEN_CFG_NODE_ID         5
...
#define CANOPEN_CFG_TICK_INTERVAL	1
    
//-------------------------------------------------------------------- [Logging]   
#define CFG_LOGGING_LEVEL           LOG_WARN                /**< \brief Defines the logging-level. See #logging_level_t */
